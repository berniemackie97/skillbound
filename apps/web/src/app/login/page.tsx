...
export default async function LoginPage({
  ...
  const callbackUrl = getStringParam(resolvedSearchParams?.callbackUrl) || '/characters';
        ...
        <div className="auth-container">
          <div className="auth-card auth-card-single">
            ...
            <p className="auth-subtitle">
              You are signed in as <strong>{session.user.email ?? session.user.name ?? 'Player'}</strong>
            </p>
    ...
    <div className="auth-page">
      <div className="auth-container">
        <div className="auth-header">
          ...
          <p>Sign in to track your characters, save progress, and sync across devices.</p>
        </div>
        ...
        <div className="auth-grid-modern">
          ...
          <div className="auth-card">
            ...
            <form className="auth-form-modern" action={handleCredentialsSignIn}>
            ...
            <form className="auth-form-modern" action={handleCredentialsRegister}>
              <div className="auth-input-group">
          ...
          <div className="auth-card">
            ...
            {hasOAuth ? (
              ...
              <p className="auth-no-providers">No OAuth providers configured.</p>
            )}
            ...
            {hasMagicLink && (
              <>
                ...
                <form className="auth-form-modern" action={handleMagicLink}>
                  <div className="auth-input-group">
