...
import { evaluateBundleDiaries } from '@/lib/requirements/requirements-evaluator';
...
export async function GET(
  ...
  try {
    ...
    const results = evaluateBundleDiaries(bundle, facts);
    ...
    console.error('Diary requirements evaluation error:', error);
    const problem = createProblemDetails({
      status: 500,
      title: 'Requirements evaluation failed',
      detail: 'Unable to evaluate diary requirements.',
    });
