...
export const WORLD_BOSSES: BossTemplate[] = [
  ...
  { name: 'Dagannoth Rex', category: 'Other', wiki_name: 'Dagannoth Rex' },
  {
    ...
    category: 'Other',
    wiki_name: 'Dagannoth Supreme',
  },
  {
    name: 'Deranged Archaeologist',
    category: 'Wilderness',
    wiki_name: 'Deranged Archaeologist',
  },
  {
    name: 'Duke Sucellus',
    category: 'Desert Treasure II',
    wiki_name: 'Duke Sucellus',
  },
  {
    name: 'General Graardor',
    category: 'God Wars',
    wiki_name: 'General Graardor',
  },
  { name: 'Giant Mole', category: 'Other', wiki_name: 'Giant Mole' },
  {
    name: 'Grotesque Guardians',
    category: 'Slayer',
    wiki_name: 'Grotesque Guardians',
  },
  ...
  { name: 'The Gauntlet', category: 'Other', wiki_name: 'The Gauntlet' },
  {
    ...
    category: 'Other',
    wiki_name: 'The Corrupted Gauntlet',
  },
  {
    name: 'The Leviathan',
    category: 'Desert Treasure II',
  ...
  },
  {
    ...
    category: 'Slayer',
    wiki_name: 'Thermonuclear smoke devil',
  },
...
export const RAID_BOSSES: BossTemplate[] = [
  {
    ...
    category: 'Raids',
    wiki_name: 'Chambers of Xeric',
  },
  {
    name: 'Chambers of Xeric: Challenge Mode',
    category: 'Raids',
    wiki_name: 'Chambers of Xeric: Challenge Mode',
  },
  {
    name: 'Theatre of Blood',
    category: 'Raids',
    wiki_name: 'Theatre of Blood',
  },
  {
    name: 'Theatre of Blood: Hard Mode',
    category: 'Raids',
    wiki_name: 'Theatre of Blood: Hard Mode',
  },
  {
    name: 'Tombs of Amascut',
    category: 'Raids',
    wiki_name: 'Tombs of Amascut',
  },
  {
    name: 'Tombs of Amascut: Expert Mode',
    category: 'Raids',
    wiki_name: 'Tombs of Amascut: Expert Mode',
  },
];
