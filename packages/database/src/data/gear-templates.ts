...
export const EARLY_GAME_GEAR: GearTemplate[] = [
  ...
  {
    slot: 'boots',
    itemName: 'Climbing boots',
    itemId: 3105,
    source: 'Death Plateau',
    priority: 3,
    style: 'all',
  },
  ...
  },
  {
    ...
    itemId: 9185,
    source: 'Temple of Ikov',
    priority: 4,
    style: 'ranged',
  },
  {
    slot: 'ammo',
    itemName: 'Broad bolts',
    itemId: 13280,
    source: '55 Slayer',
    priority: 4,
    style: 'ranged',
  ...
  {
    slot: 'weapon',
    itemName: "Iban's staff",
    itemId: 1409,
    source: 'Underground Pass',
    priority: 5,
    style: 'magic',
  },
  {
...
export const MID_GAME_GEAR: GearTemplate[] = [
  ...
  },
  {
    ...
    itemId: 4151,
    source: 'Abyssal demons (85 Slayer)',
    priority: 5,
    style: 'melee',
  },
  {
  ...
  // Magic
  {
    ...
    itemId: 11905,
    source: 'Cave kraken (87 Slayer)',
    priority: 5,
    style: 'magic',
  },
  {
    slot: 'staff',
    itemName: 'Ancient staff',
    itemId: 4675,
    source: 'Desert Treasure',
    priority: 4,
    style: 'magic',
  },
  {
    slot: 'body',
    itemName: "Ahrim the Blighted's robetop",
    itemId: 4712,
    source: 'Barrows',
    priority: 4,
    style: 'magic',
  ...
  {
    slot: 'legs',
    itemName: "Ahrim the Blighted's robeskirt",
    itemId: 4714,
    source: 'Barrows',
    priority: 4,
    style: 'magic',
